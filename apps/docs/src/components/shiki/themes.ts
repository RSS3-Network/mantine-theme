export const light = {
	...
	tokenColors: [
		...
		{
			scope:
				'storage.type.function.arrow,keyword.operator.arrow,keyword.operator.closure,',
			settings: {
				fontStyle: '',
				foreground: '#437AED',
			},
		...
		{
			scope:
				'comment,comment markup.link,punctuation.definition.comment,markup.quote.markdown',
			settings: {
				fontStyle: 'italic',
				foreground: '#A9A9AA',
			},
